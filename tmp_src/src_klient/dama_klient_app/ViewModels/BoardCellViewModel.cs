...
public class BoardCellViewModel : ViewModelBase
{
    ...
    public BoardCellViewModel(int row, int col, int serverRow, int serverCol)
    {
        Row = row;
        Col = col;
        ServerRow = serverRow;
    ...
    public int ServerRow { get; }

    public int ServerCol { get; }
    ...
    {
        get => _clickCommand;
        set => SetField(ref _clickCommand, value);
    }
}

/// <summary>
/// VM figurky (barva/dáma) pro vykreslení.
/// </summary>
