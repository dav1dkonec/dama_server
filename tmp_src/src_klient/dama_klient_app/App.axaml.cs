...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        ...
        if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            desktop.Exit += OnExitRequested;
        }

        base.OnFrameworkInitializationCompleted();
    }

    private async void OnExitRequested(object? sender, ControlledApplicationLifetimeExitEventArgs e)
    {
        try
        {
            await AppServices.GameClient.SendByeAsync();
            await AppServices.GameClient.DisposeAsync();
        }
        catch
        {
